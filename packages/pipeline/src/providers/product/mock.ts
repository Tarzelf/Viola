...
const CATALOGUE: CatalogueEntry[] = [
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/hoka-skyward-x-blue.png',
    rating: 4.6,
    reviewCount: 812,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/hoka-nordstrom.png',
    rating: 4.5,
    reviewCount: 143,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/hoka-posh.png',
    rating: null,
    reviewCount: null,
    isSecondhand: true,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/brooks-ghost.png',
    rating: 4.7,
    reviewCount: 2210,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/coros-pace-pro.png',
    rating: 4.8,
    reviewCount: 1240,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/ua-launch.png',
    rating: 4.5,
    reviewCount: 3410,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/aritzia-effortless.png',
    rating: 4.7,
    reviewCount: 2210,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/depop-aritzia.png',
    rating: null,
    reviewCount: null,
    isSecondhand: true,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/samba-og.png',
    rating: 4.8,
    reviewCount: 9820,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/uniqlo-turtleneck.png',
    rating: 4.4,
    reviewCount: 5120,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/levis-501-90s.png',
    rating: 4.6,
    reviewCount: 4400,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/thredup-levis.png',
    rating: null,
    reviewCount: null,
    isSecondhand: true,
  }),
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/cos-tote.png',
    rating: 4.3,
    reviewCount: 88,
  }),
  entry({
  ...
  entry({
    ...
    imageUrl: 'https://cdn.viola-fixtures.test/mango-sunglasses.png',
    rating: 4.0,
    reviewCount: 41,
  }),
];
